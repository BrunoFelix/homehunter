...
- **Zap/VivaReal — ainda bloqueados**: retornaram **0 listagens** ("anti-bot engaged") → fallback com dados de amostra. Necessário contra-medidas (User-Agent real, headers/JS rendering, proxy/rotacionamento) antes de produção.
