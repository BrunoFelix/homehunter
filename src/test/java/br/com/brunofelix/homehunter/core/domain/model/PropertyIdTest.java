...
class PropertyIdTest {
    ...
    void shouldGenerateDifferentIdForDifferentTypes() {
        PropertyId id1 = PropertyId.generate("PE", "Recife", "Boa Viagem", PropertyType.APARTAMENTO, 80.0, 3);
        PropertyId id2 = PropertyId.generate("PE", "Recife", "Boa Viagem", PropertyType.CASA, 80.0, 3);
    ...
    void shouldReturnCorrectLengthForSha256() {
        PropertyId id = PropertyId.generate("PE", "Recife", "Boa Viagem", PropertyType.APARTAMENTO, 80.0, 3);
